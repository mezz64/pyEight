...
async def test_update_user_data(client_session):
    ...
    assert user.current_session_date == datetime(2022, 3, 21, 15, 8)
    ...
    assert user.last_session_date == datetime(2022, 3, 21, 0, 12)
